...
require 'which-key'.register {
  ...
  ['<c-/>'] = { name = 'proj_buffer', },
  ['<c-/>a'] = { function() M.split_all_other_proj_buffer() end, 'split all other proj buffer', mode = { 'n', 'v', }, },
  ['<c-/>j'] = { function() M.just_split_other_proj_buffer() end, 'just split other proj buffer', mode = { 'n', 'v', }, },
